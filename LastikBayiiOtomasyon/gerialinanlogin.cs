...
{
    public partial class gerialinanlogin : Form
    {
        ...
        public string tip = "Geri Alınan Giriş";
        public DateTime tarih = DateTime.Now;

        public gerialinanlogin()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                sorgu = string.Format("select * from personel where personelkadi='" + textBox1.Text + "' and personelsifre='" + textBox2.Text + "' and personeltipi='Satis Elemani'");
                ...
                if (oku.HasRows)
                {
                    ...
                    gerialinan gerialinan = new gerialinan();
                    gerialinan.Show();
                    this.Close();
                }
                else
